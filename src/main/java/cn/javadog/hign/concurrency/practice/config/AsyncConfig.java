package cn.javadog.hign.concurrency.practice.config;
...
public class AsyncConfig {
    ...
    public static final String EXECUTOR_ONE_BEAN_NAME = "executor-echo";
    public static final String EXECUTOR_TWO_BEAN_NAME = "executor-single";
    ...
    public static class ExecutorOneConfiguration {
        ...
        @Primary
        @ConfigurationProperties(prefix = "spring.task.executor-echo") // 读取 spring.task.execution-one 配置到 TaskExecutionProperties 对象
        public TaskExecutionProperties taskExecutionProperties() {
            return new TaskExecutionProperties();
        }

        @Bean(name = EXECUTOR_ONE_BEAN_NAME)
        @ConfigurationProperties(prefix = "spring.task.executor-echo.shutdown")
    ...
    public static class ExecutorTwoConfiguration {
        ...
        @ConfigurationProperties(prefix = "spring.task.executor-single") // 读取 spring.task.execution-two 配置到 TaskExecutionProperties 对象
        public TaskExecutionProperties taskExecutionProperties() {
            return new TaskExecutionProperties();
        }
        ...
        @ConfigurationProperties(prefix = "spring.task.executor-single.shutdown")
        public ThreadPoolTaskExecutor threadPoolTaskExecutor() {
            // 创建 TaskExecutorBuilder 对象
            TaskExecutorBuilder builder = createTskExecutorBuilder(this.taskExecutionProperties());
            // 创建 ThreadPoolTaskExecutor 对象
